...
const DICT: Record<string, { en: string; hi: string }> = {
  ...
  'reg.vendorCode': { en: 'Vendor code (optional)', hi: 'वेंडर कोड (वैकल्पिक)' },
  'reg.vendorCodeHint': { en: 'Have a code from the company? Enter it to link your account. Leave blank to be set up as a new vendor.', hi: 'कंपनी से कोड मिला है? अपना अकाउंट जोड़ने के लिए डालें। खाली छोड़ें तो नया वेंडर बनेगा।' },
  ...
  'admin.createLogin': { en: 'Create login', hi: 'लॉगिन बनाएँ' },
  'admin.createLoginHint': { en: 'Give this vendor a login so they can sign in, acknowledge purchase orders and see their performance.', hi: 'इस वेंडर को लॉगिन दें ताकि वे साइन इन करके पर्चेज़ ऑर्डर स्वीकारें और परफ़ॉर्मेंस देखें।' },
  'admin.loginCreated': { en: 'Login created — share these with the vendor:', hi: 'लॉगिन बन गया — वेंडर को यह दें:' },
  'vendor.onTimeHistory': { en: 'On-time delivery history', hi: 'समय पर डिलीवरी इतिहास' },
  'vendor.historyNote': { en: 'Each bar is a snapshot; metrics update as purchase orders change.', hi: 'हर बार एक स्नैपशॉट है; पर्चेज़ ऑर्डर बदलने पर आँकड़े अपडेट होते हैं।' },
  'vendor.noHistory': { en: 'No history yet — it builds up as purchase orders are completed.', hi: 'अभी इतिहास नहीं — पर्चेज़ ऑर्डर पूरे होने पर बनता है।' },
  'vendor.snapshots': { en: 'Snapshots recorded', hi: 'दर्ज स्नैपशॉट' },
  ...
  'admin.deleteConfirm': { en: 'Delete this permanently? This cannot be undone.', hi: 'पक्का हमेशा के लिए हटाएँ? यह वापस नहीं आएगा।' },
  'admin.deleteFailed': { en: 'Could not delete', hi: 'हटाया नहीं जा सका' },
  'admin.users': { en: 'Users', hi: 'सभी यूज़र' },
  'admin.noUsers': { en: 'No users.', hi: 'कोई यूज़र नहीं।' },
  'admin.joined': { en: 'Joined', hi: 'जुड़े' },
  'admin.viewAs': { en: 'Open any role (view as)', hi: 'किसी भी भूमिका में देखें' },
  'admin.viewAsHint': { en: 'Step into a role to see exactly what they see — and add their list, orders or details.', hi: 'किसी भूमिका में जाकर देखें कि उन्हें क्या दिखता है — और उनकी लिस्ट, ऑर्डर या जानकारी जोड़ें।' },
  'admin.viewingAs': { en: 'Viewing as', hi: 'देख रहे हैं' },
  'admin.returnToAdmin': { en: 'Return to admin', hi: 'एडमिन पर लौटें' },
  'admin.noneOfRole': { en: 'No such account yet', hi: 'ऐसा अकाउंट अभी नहीं' },
  'admin.items': { en: 'Items', hi: 'सामान' },
  ...
  'dir.viewDetails': { en: 'View details', hi: 'पूरी जानकारी' },

  // ---- shop detail page & richer fields ----
  'shop.about': { en: 'About the shop', hi: 'दुकान के बारे में' },
  'shop.owner': { en: 'Owner', hi: 'मालिक' },
  'shop.ownerName': { en: 'Owner name', hi: 'मालिक का नाम' },
  'shop.timings': { en: 'Timings', hi: 'समय' },
  'shop.openToday': { en: 'Open today', hi: 'आज खुला' },
  'shop.weeklyOff': { en: 'Weekly off', hi: 'साप्ताहिक अवकाश' },
  'shop.deliveryTime': { en: 'Delivery time', hi: 'डिलीवरी समय' },
  'shop.min': { en: 'min', hi: 'मिनट' },
  'shop.altPhone': { en: 'Alternate phone', hi: 'दूसरा नंबर' },
  'shop.payment': { en: 'Payment', hi: 'भुगतान' },
  'shop.paymentModes': { en: 'Payment accepted', hi: 'भुगतान के तरीके' },
  'shop.gst': { en: 'GST / licence no.', hi: 'GST / लाइसेंस नं.' },
  'shop.established': { en: 'Serving since', hi: 'से सेवा में' },
  'shop.establishedYear': { en: 'Established year', hi: 'स्थापना वर्ष' },
  'shop.serviceAreas': { en: 'Delivers to', hi: 'डिलीवरी क्षेत्र' },
  'shop.minOrder': { en: 'Minimum order', hi: 'कम से कम ऑर्डर' },
  'shop.deliveryRadius': { en: 'Delivery area', hi: 'डिलीवरी दूरी' },
  'shop.rateBoard': { en: 'Rate list', hi: 'रेट लिस्ट' },
  'shop.contact': { en: 'Contact & visit', hi: 'संपर्क और पता' },
  'shop.orderNow': { en: 'Order from this shop', hi: 'इस दुकान से ऑर्डर करें' },
  'shop.photo': { en: 'Shop photo', hi: 'दुकान की फोटो' },
  'shop.notListed': { en: 'This shop is not available.', hi: 'यह दुकान उपलब्ध नहीं है।' },
  'shop.cash': { en: 'Cash', hi: 'नकद' },
  'shop.card': { en: 'Card', hi: 'कार्ड' },
